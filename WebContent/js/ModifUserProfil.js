...
$(document).ready(
        function() {
            ...
            $('#listBtnOrdonnance').click(function() {
                console.log("ici2");
                $('#listOrdonnance').slideToggle("slow");
            });
            ...
            //colorer l'imc si non normal
            console.log("test: "+$('#myImcComm').val());
            console.log("test2: "+$('#myImcComm').html());
            console.log("test3: "+$('#myImcComm').text());

            if ($('#myImcComm').html()==="sous-poids") {
                console.log("ici1");
                $('#myImc').addClass("bg-warning");
                $('#myImc').removeClass("bg-danger");
                $('#myImc').removeClass("bg-success");
            } else if ($('#myImcComm').html()==="surpoids") {
                console.log("ici2");
                $('#myImc').addClass("bg-danger");
                $('#myImc').removeClass("bg-warning");
                $('#myImc').removeClass("bg-success");
            } else {
                console.log("ici3");
                $('#myImc').removeClass("bg-warning")
                $('#myImc').removeClass("bg-danger")
                $('#myImc').addClass("bg-success");
            }

            //colorer rdv, analyse, examen
            //console.log($('.listeRdv').html());
            // console.log($('.listeRdv').text());
            //  console.log($('.listeRdv').val());
