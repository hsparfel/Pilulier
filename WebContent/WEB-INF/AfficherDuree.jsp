	...
	<div class="container">
		<div class="row">
			<div class="col-xs-12 col-sm-8">
				<div class="jumbotron">
					<h1>Afficher une duree</h1>
				</div>

				<form action="AfficherDureeAction" method="post">
					<div class="form-group row d-none">
						<label for="idDuree" class="col-2 col-form-label">Id</label>
						<div class="col-6">
					...
					<div class="form-group row">
						<label for="nomDuree" class="col-2 col-form-label">Nom</label>
						<div class="col-6">
							<div class="input-group">
								<div class="input-group-prepend">
									<div class="input-group-text">
					...
					<div class="form-group row">
						<div class="offset-2 col-10">
							...
							<a href="EnregistrerDuree" id="ajouter"
