...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-xs-12 col-sm-9">
				<div class="jumbotron">
					<h1>Afficher une utilisateur</h1>
				</div>

				<form action="AfficherUtilisateurAction" method="post">
					<div class="form-group row d-none">
						<label for="idUtilisateur" class="col-2 col-form-label">Id</label>
						<div class="col-6">
							<div class="input-group">
								...
								<input id="idUtilisateur" name="idUtilisateur"
									value="${ maUtilisateur.id }" type="text"
									aria-describedby="idUtilisateurHelpBlock" required="required"
						...
						<div class="col-6">
							<div class="input-group">
								...
								<input id="nomUtilisateur" name="nomUtilisateur"
									value="${ maUtilisateur.nom }"  type="text"
					...
					<div class="form-group row">
						<div class="offset-2 col-10">
							...
							<a href="AfficherUtilisateur?id=${ maUtilisateur.id }" id="cancel"
	...
	<script
		...
		crossorigin="anonymous"></script>
<script src="js/AfficherUtilisateur.js"></script>
